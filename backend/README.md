...
## Project Structure
    ...
    ├── testapiautoconnecto_78054  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_78054`
...
2. Clone this repo and `cd testapiautoconnecto_78054`
